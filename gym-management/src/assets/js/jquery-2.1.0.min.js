...
!(function (a, b) {
	...
	function (a, b) {
		...
		(o.fn = o.prototype =
			...
			o.extend({
				expando:
					"jQuery" + (n + Math.random()).replace(/\D/g, ""),
				isReady: !0,
				error: function (a) {
					throw new Error(a);
				},
		...
		var t = (function (a) {
				...
				if (n && !e) {
					if ((f = Z.exec(a)))
						if ((h = f[1])) {
							...
							if (f[2])
								return (
									G.apply(d, b.getElementsByTagName(a)), d
								);
							if (
								(h = f[3]) &&
			...
			function mb(a) {
				return (
					a && typeof a.getElementsByTagName !== A && a
				);
			}
			(c = db.support = {}),
				(f = db.isXML =
		...
		o.extend({
			...
			o.fn.extend({
				...
				add: function (a, b) {
					return this.pushStack(
						o.unique(o.merge(this.get(), o(a, b)))
					);
				},
				addBack: function (a) {
					return this.add(
		...
		o.each(
			{
				...
				contents: function (a) {
					return (
						a.contentDocument || o.merge([], a.childNodes)
					);
				},
			},
			function (a, b) {
		...
		function P(a, b, c) {
			...
			if (void 0 === c && 1 === a.nodeType)
				if (
					((d =
						"data-" + b.replace(O, "-$1").toLowerCase()),
					(c = a.getAttribute(d)),
					"string" == typeof c)
				) {
					try {
		...
		!(function () {
			...
			(b.innerHTML =
				...
				(l.noCloneChecked = !!b.cloneNode(!0).lastChild
					.defaultValue);
		})();
		var U = "undefined";
		...
		(o.event = {
								...
								(k = o.extend(
									{
										...
										needsContext:
											e &&
											o.expr.match.needsContext.test(e),
										namespace: p.join("."),
									},
									f
								)),
			...
			simulate: function (a, b, c, d) {
				...
				d
					? o.event.trigger(e, null, b)
					: o.event.dispatch.call(b, e),
		...
		function ob(a, b) {
			var c = a.getElementsByTagName
				...
				: [];
			return void 0 === b || (b && o.nodeName(a, b))
				? o.merge([a], c)
				: c;
		}
		function pb(a, b) {
				...
				for (
					...
					if (((e = a[m]), e || 0 === e))
						if ("object" === o.type(e))
							...
							(f =
								f || k.appendChild(b.createElement("div"))),
								(g = (bb.exec(e) || [
									"",
									"",
								])[1].toLowerCase()),
			...
			cleanData: function (a) {
				for (
					...
					if (
						...
						if (
							((d = Object.keys(b.events || {})), d.length)
						)
		...
		o.extend({
			...
			style: function (a, b, c, d) {
				if (
					...
					return (
						(b =
							o.cssProps[h] || (o.cssProps[h] = Fb(i, h))),
			...
			(o.cssHooks.marginRight = yb(
				l.reliableMarginRight,
				function (a, b) {
					return b
						? o.swap(a, { display: "inline-block" }, xb, [
								a,
								"marginRight",
						  ])
						: void 0;
			...
			(o.speed = function (a, b, c) {
				var d =
					a && "object" == typeof a
						...
						: {
								complete:
									c || (!c && b) || (o.isFunction(a) && a),
								duration: a,
								easing:
									(c && b) || (b && !o.isFunction(b) && b),
						  };
				return (
					(d.duration = o.fx.off
						? 0
		...
		o.fn.extend({
			...
			o.each(
				o.expr.match.bool.source.match(/\w+/g),
				function (a, b) {
			...
			ajax: function (a, b) {
				...
				if (
					...
					(k.url = ((a || k.url || fc) + "")
						...
						.replace(lc, ec[1] + "//")),
					(k.type =
						b.method || b.type || k.method || k.type),
					(k.dataTypes = o
						.trim(k.dataType || "*")
						.toLowerCase()
						.match(E) || [""]),
		...
		(o.param = function (a, b) {
			...
			if (
				(void 0 === b &&
					(b =
						o.ajaxSettings && o.ajaxSettings.traditional),
						...
						return (
							...
							o.contains(b, d)
								? (typeof d.getBoundingClientRect !== U &&
								  ...
								  {
										top:
											e.top + c.pageYOffset - b.clientTop,
										left:
				...
				position: function () {
					if (this[0]) {
						...
						return (
							...
							{
								top:
									b.top - d.top - o.css(c, "marginTop", !0),
								left:
									b.left -
									d.left -
									o.css(c, "marginLeft", !0),
							}
						);
					}
				},
