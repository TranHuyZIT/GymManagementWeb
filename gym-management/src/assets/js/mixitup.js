	...
	!(function () {
		...
		(e = function (a, i, o) {
			...
			if (
				...
				if (!a || "object" != typeof a || !a.length)
					throw new Error(
						e.messages.errorFactoryInvalidContainer()
					);
				m = a;
			}
			if (m.length < 1)
				throw new Error(
					e.messages.errorFactoryContainerNotFound()
				);
				...
				r.id
					...
					e.instances[d] instanceof e.Mixer
						...
						: ((l = new e.Mixer()),
						  ...
						  (e.instances[d] = l)),
					(c = new e.Facade(l)),
					i && i.debug && i.debug.enable
						? h.push(l)
						: h.push(c);
			return (f = s ? new e.Collection(h) : h[0]);
		}),
		(e.use = function (t) {
			e.Base.prototype.callActions.call(
				e,
				"beforeUse",
				arguments
			),
				"function" == typeof t &&
				"mixitup-extension" === t.TYPE
		...
		(n = {
			...
			pascalCase: function (t) {
				return (
					(t = this.camelCase(t)).charAt(0).toUpperCase() +
					t.slice(1)
				);
			},
			dashCase: function (t) {
			...
			getClassname: function (t, e, n) {
				...
				return (
					...
					n
						? (a.length && (a += t.delineatorModifier),
						  (a += n))
						: a
				);
			},
		...
		(e.Features.prototype = Object.create(
			e.Base.prototype
		)),
		n.extend(e.Features.prototype, {
			...
			runTests: function () {
				...
				e.callActions("beforeRunTests", arguments),
					...
					(e.has.transitions =
						"unsupported" !== e.transitionPrefix),
			...
			setPrefixes: function () {
				...
				t.callActions("beforeSetPrefixes", arguments),
					...
					(t.boxSizingProp = t.boxSizingPrefix
						? t.boxSizingPrefix +
						  n.pascalCase(t.BOX_SIZING_PROP)
						: t.BOX_SIZING_PROP),
					(t.transitionProp = t.transitionPrefix
						? t.transitionPrefix +
						  n.pascalCase(t.TRANSITION_PROP)
						: t.TRANSITION_PROP),
					(t.transformProp = t.transformPrefix
						? t.transformPrefix +
						  n.pascalCase(t.TRANSFORM_PROP)
						: t.TRANSFORM_PROP),
					...
					(t.perspectiveProp = t.transformPrefix
						? t.transformPrefix +
						  n.pascalCase(t.PERSPECTIVE_PROP)
						: t.PERSPECTIVE_PROP),
		...
		(e.MixerDom.prototype = Object.create(
			e.Base.prototype
		)),
		...
		n.extend(e.Control.prototype, {
			...
			handleClick: function (t) {
				...
				switch (a.type) {
					case "filter":
						l.filter =
							a.filter || i.getAttribute("data-filter");
						break;
					case "sort":
					...
					case "toggle":
						(l.filter =
							a.filter || i.getAttribute("data-toggle")),
							(r =
								"live" === a.status
			...
			updateLive: function (t, n) {
				...
				if (
					...
					for (
						...
						switch (
							((o = new e.CommandMultimix()), a.type)
						) {
							case "filter":
		...
		(e.StyleData.prototype = Object.create(
			e.Base.prototype
		)),
		...
		(e.QueueItem.prototype = Object.create(
			e.Base.prototype
		)),
		...
		n.extend(e.Mixer.prototype, {
			...
			cacheDom: function (t, e) {
				...
				n.callActions("beforeCacheDom", arguments),
					(n.dom.document = e),
					(n.dom.body =
						n.dom.document.querySelector("body")),
					(n.dom.container = t),
					(n.dom.parent = t),
			...
			getControl: function (t, a, i) {
				var o = this,
					...
					s = -1;
				if (
					(o.callActions("beforeGetControl", arguments), !i)
				)
			...
			getToggleSelector: function () {
				var t = this,
					e =
						"or" === t.config.controls.toggleLogic
							? ", "
							: "",
					a = "";
				return (
			...
			buildToggleArray: function (t, e) {
				...
				(i !== a.config.selectors.target && "all" !== i) ||
					(i = ""),
			...
			parseEffects: function () {
				...
				for (n in e.transformDefaults)
					e.transformDefaults[n] instanceof
						e.TransformData &&
						(t.parseEffect(
							n,
							a,
			...
			goMix: function (a, i) {
				...
				return (
					...
					"function" ==
						typeof o.config.callbacks.onMixStart &&
				...
				for (
					...
					for (
						i = t.showPosData[u],
							...
							i.posOut.x =
								i.finalPosData.x - i.interPosData.x,
							i.posOut.y =
								i.finalPosData.y - i.interPosData.y,
			...
			cleanUp: function (t) {
				...
				t.willSort && (a.targets = t.newOrder),
					...
					"function" ==
						typeof a.config.callbacks.onMixEnd &&
					...
					t.hasFailed &&
						...
						"function" ==
							typeof a.config.callbacks.onMixFail &&
					...
					a.queue.length &&
						...
						s.instruction.command instanceof
						e.CommandMultimix
			...
			parseFilterArgs: function (t) {
				...
				if (i.command.selector && i.command.collection)
					throw new Error(
						e.messages.errorFilterInvalidArguments()
					);
				return (
					(i = a.callFilters(
			...
			parseInsertArgs: function (t) {
				...
				if (i.command.index && i.command.sibling)
					throw new Error(
						e.messages.errorInsertInvalidArguments()
					);
				return (
					!i.command.collection.length &&
						a.config.debug.showWarnings &&
			...
			parseRemoveArgs: function (t) {
				...
				return (
					!i.command.targets.length &&
						a.config.debug.showWarnings &&
						console.warn(
							e.messages.warningRemoveNoElements()
						),
					n.freeze(i),
					i
				);
				...
				return (
					...
					a.queue.length < a.config.animation.queueLimit
						...
						: (a.config.debug.showWarnings &&
						  ...
						  "function" ==
								typeof a.config.callbacks.onMixBusy &&
			...
			diffDatasets: function (t) {
				...
				for (
					...
					if (
						"undefined" ==
							typeof (d = s[a.config.data.uidKey]) ||
						d.toString().length < 1
					)
						throw new TypeError(
			...
			insertDatasetFrag: function (t, e, a) {
				var i = this,
					o = e
						? n
								.arrayFromList(i.dom.parent.children)
								.indexOf(e)
						: i.targets.length;
		...
		(e.IMoveData.prototype = Object.create(
			e.Base.prototype
		)),
		...
		(e.TargetDom.prototype = Object.create(
			e.Base.prototype
		)),
		...
		n.extend(e.Target.prototype, {
			...
			init: function (t, n, a) {
				...
				if (
					...
					if (
						"undefined" ==
							typeof (o = a[n.config.data.uidKey]) ||
						o.toString().length < 1
					)
						throw new TypeError(
							e.messages.errorDatasetInvalidUidKey({
			...
			applyStylesIn: function (t) {
				...
				n.callActions("beforeApplyStylesIn", arguments),
					...
					(n.dom.el.style[e.features.transformProp] =
						o.join(" ")),
			...
			applyStylesOut: function (t) {
				var n = this,
					...
					r =
						"undefined" != typeof n.mixer.effectsIn.opacity;
				if (
			...
			writeTransitionRule: function (t, e, n) {
				...
				return (
					(o =
						...
						(n > 0
							? n
							: a.mixer.config.animation.duration) +
						"ms " +
						i +
						"ms " +
						("opacity" === t
			...
			getDelay: function (t) {
				...
				return (
					"function" ==
						typeof e.mixer.config.animation
							.staggerSequence &&
						(t =
							e.mixer.config.animation.staggerSequence.call(
								e,
								t,
								e.state
							)),
			...
			handleTransitionEnd: function (t) {
				...
				e.callActions(
					"beforeHandleTransitionEnd",
					arguments
				),
					e.isBound &&
						t.target.matches(
							e.mixer.config.selectors.target
						) &&
		...
		(e.Collection = function (t) {
			var e = null,
				a = -1;
			for (
				this.callActions("beforeConstruct"), a = 0;
				(e = t[a]);
				a++
			)
				this[a] = e;
		...
		(e.Collection.prototype = Object.create(
			e.Base.prototype
		)),
		...
		(e.Operation.prototype = Object.create(
			e.Base.prototype
		)),
		...
		(e.Messages.prototype = Object.create(
			e.Base.prototype
		)),
