...
!(function (t, e) {
			...
			function r(t, e) {
				(this._items = null),
					...
					(this._indicatorsElement =
						this._element.querySelector(ot)),
			...
			return (
				...
				(t.nextWhenVisible = function () {
					!document.hidden &&
						...
						"hidden" !==
							g(this._element).css("visibility") &&
						this.next();
				}),
				(t.prev = function () {
				...
				(t.to = function (t) {
					var e = this;
					this._activeElement =
						this._element.querySelector(tt);
				...
				(r._jQueryInterface = function (i) {
					return this.each(function () {
						...
						if (
							(t ||
								((t = new r(this, e)), g(this).data(j, t)),
							"number" == typeof i)
						)
							t.to(i);
		...
		Jt = (function () {
			...
			return (
					...
					if (
						...
						if ((c._clearMenus(), !e)) {
							var n = { relatedTarget: this._element },
								i = g.Event(kt.SHOW, n);
							if (
								(g(t).trigger(i), !i.isDefaultPrevented())
							) {
								if (!this._inNavbar) {
				...
				(t._detectNavbar = function () {
					return (
						0 < g(this._element).closest(".navbar").length
					);
				}),
	...
	g(document)
		...
		.on(
			kt.CLICK_DATA_API + " " + kt.KEYUP_DATA_API,
			Jt._clearMenus
		)
			...
			return (
				...
				(o._jQueryInterface = function (n, i) {
					return this.each(function () {
						...
						if (
							(t ||
								((t = new o(this, e)), g(this).data(te, t)),
							"string" == typeof n)
						) {
							if ("undefined" == typeof t[n])
								throw new TypeError(
		...
		Be = (function () {
			...
			return (
				...
				(t.getTipElement = function () {
					return (
						(this.tip =
							this.tip || g(this.config.template)[0]),
						this.tip
					);
				}),
				...
				(i._jQueryInterface = function (n) {
					return this.each(function () {
						...
						if (
							...
							(t ||
								((t = new i(this, e)), g(this).data(Ie, t)),
							"string" == typeof n)
						) {
							if ("undefined" == typeof t[n])
								throw new TypeError(
				...
				(i._jQueryInterface = function (n) {
					return this.each(function () {
						...
						if (
							(t || !/dispose|hide/.test(n)) &&
							(t ||
								((t = new i(this, e)), g(this).data(Ye, t)),
							"string" == typeof n)
						) {
							if ("undefined" == typeof t[n])
								throw new TypeError(
		...
		Dn = (function () {
			...
			return (
				...
				(t._activate = function (e) {
					...
					n.hasClass(gn)
						? (n.closest(Cn).find(Sn).addClass(_n),
						  n.addClass(_n))
						: (n.addClass(_n),
						  n
								.parents(pn)
